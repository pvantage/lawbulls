        ...
        $(authWindow).on('loadstart', function(e) {
            ...
            if (code) {
                ...
                $.post('https://accounts.google.com/o/oauth2/token', {
                    ...
                    $("#get_name").html('Name: ' + data.given_name);
...
function callGoogle() {
    ...
    //  alert('starting');
    googleapi.authorize({
        client_id: '605980070191-h41pio74e2bi8b8gj1df8qose4hvp5kd.apps.googleusercontent.com',
        client_secret: 'l11lnCRzYeO2dAMsu6YZCy7i',
